...
module.exports = function mapContent (contentArr) {
  ...
  // DEV: In that case, we would also build 2 mappers one for the normal resolve and one for the nested object.
      ...
      Current strategy:
        If the value is an array
          ...
          If any item is an object
            Collect them into a super-object {before[], after[], ...}
        Otherwise
          Lookup the item
            If the item is an object and we are aliasing to an object, error out
     */
