          ...
          if (typeof val === 'object') {
            ...
            ['before', 'beforeEach', 'afterEach', 'after'].forEach(function resolveBeforeEtcAliases (key) {
              ...
              if (val !== undefined) {
                ...
                var valObj = this.lookup(val, {alias: true, map: true, flatten: true});
                // TODO: I think it might be borked since we don't call alias/map explicitly o_O
                console.log('yy', val, valObj);
