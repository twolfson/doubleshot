...
Doubleshot.prototype = _.defaults({
  ...
  loadFiles: function (fn) {
    ...
    // TODO: Technically, this outline semantics should be handled on a per-content basis
    ...
    // Temporarily save global hooks onto
    ...
    var mappedContent = {};
    Object.getOwnPropertyNames(content).forEach(getValue);

    // TODO: Deal with this properly... we can have multiple global hooks across files
    // TODO: Move all globalBefore(after, etc) into arrays
    // TODO: Flatten the arrays
    // TODO: Map them as per normal
    // TODO: Invoke them once all requires have been setup
